...
@Component({
  selector: 'app-a-documents',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, QRCodeModule],
  templateUrl: './a-documents.component.html',
  styleUrls: ['./a-documents.component.css']
})
export class ADocumentsComponent implements OnInit {
...
generateUniqueCode(): string {
  ...
  openReleaseModal(documentCode: string): void {
    ...
    this.releaseDocumentInfo.set({ code: documentCode, receivingOffice: '', message: '' });
