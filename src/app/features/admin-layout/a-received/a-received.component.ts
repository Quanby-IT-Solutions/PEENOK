...
import { SupabaseService, ReceivedDocument } from '../../../core/services/supabase.service';
...
@Component({
  selector: 'app-a-received',
  standalone: true,
  imports: [CommonModule, FormsModule, RouterLink, QRCodeModule],
  templateUrl: './a-received.component.html',
  styleUrls: ['./a-received.component.css']
})
export class AReceivedComponent implements OnInit {
